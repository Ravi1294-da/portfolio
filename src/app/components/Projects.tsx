...
const projects = [
  ...
  },
  {
    ...
    metric: 85,
    description:
      "Desktop GUI app lets non-technical staff select an Excel file and trigger a full workflow with one click — personalised pay emails to every faculty member and colour-coded Excel summary reports to each supervisor via Outlook.",
    filter: "Python",
  },
  {
    id: 3,
